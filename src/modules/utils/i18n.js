...
const translations = {
  en: {
    ...
    helpChecklistsContent: 'Use the page pills at the top to switch pages. Scroll horizontally if you have many. Tap to switch, double-tap for Rename/Delete menu, long-press then drag to reorder the pills. The bar keeps your scroll position so you stay where you were.',
  ...
  hr: {
    ...
    helpChecklistsContent: 'Koristi kartice stranica na vrhu za prebacivanje. Pomiči vodoravno kada ih ima puno. Dodir za promjenu, dvostruki dodir za meni Preimenuj/Izbriši, dugi pritisak i povuci za promjenu redoslijeda. Traka ostaje na istom pomaku.',
  ...
  it: {
    ...
    helpChecklistsContent: 'Usa le pillole in alto per cambiare pagina. Scorri orizzontalmente se ce ne sono molte. Tocca per passare, doppio tap per il menu Rinomina/Elimina, pressione prolungata e trascina per riordinarle. La barra resta dove l’hai lasciata.',
  ...
  de: {
    ...
    helpChecklistsContent: 'Nutzen Sie die Seiten-Tabs oben, um zu wechseln. Horizontal scrollen, wenn viele vorhanden sind. Tippen zum Wechseln, Doppeltippen für Umbenennen/Löschen-Menü, lang drücken und ziehen zum Umordnen. Die Leiste bleibt an der gleichen Scroll-Position.',
