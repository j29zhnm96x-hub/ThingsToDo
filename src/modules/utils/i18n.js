...
const translations = {
  en: {
    ...
    deletePageConfirmEmpty: 'This page has no items. Delete it?',
    itemsWillBeDeleted: 'items will be deleted.',
    pageActions: 'Choose an action for this page',
    protectedKept: 'protected will be kept',
    deleteCompletedCount: 'Delete {n} completed items?',
    deleteAllCompleted: 'Delete all {n} completed items?',
    ...
    doubleTapToAdd: 'Double tap to add',
  ...
  hr: {
    ...
    deletePageConfirmEmpty: 'Ova stranica nema stavki. Obrisati?',
    itemsWillBeDeleted: 'stavki će biti obrisano.',
    pageActions: 'Odaberi radnju za stranicu',
    protectedKept: 'zaštićenih će ostati',
    deleteCompletedCount: 'Obrisati {n} završenih stavki?',
    deleteAllCompleted: 'Obrisati svih {n} završenih stavki?',
    deleteCompleted: 'Obrisati završene?',
    deleteAll: 'Obriši sve',
    allProtected: 'Sve zaštićeno',
    allProtectedMessage: 'Sve završene stavke su zaštićene i ne mogu se obrisati.',
    chooseAction: 'Odaberi radnju',
    itemDetails: 'Detalji stavke',
    addItem: 'Dodaj stavku',
    itemName: 'Naziv stavke',
    editItem: 'Uredi stavku',
    deleteItem: 'Obrisati stavku?',
    doubleTapToAdd: 'Dvaput dodirni za dodavanje',
    taskProtected: 'Zadatak zaštićen',
    taskProtectedMessage: 'Ovaj zadatak je zaštićen. Uklonite "Zaštiti zadatak" u uređivaču da biste ga obrisali.',
  ...
  it: {
    ...
    deletePageConfirmEmpty: 'Questa pagina non ha elementi. Eliminarla?',
    itemsWillBeDeleted: 'elementi saranno eliminati.',
    pageActions: 'Scegli un\'azione per questa pagina',
    protectedKept: 'protetti verranno mantenuti',
    deleteCompletedCount: 'Eliminare {n} elementi completati?',
    deleteAllCompleted: 'Eliminare tutti i {n} elementi completati?',
    deleteCompleted: 'Eliminare completati?',
    deleteAll: 'Elimina tutto',
    allProtected: 'Tutti protetti',
    ...
    doubleTapToAdd: 'Tocca due volte per aggiungere',
    taskProtected: 'Attività protetta',
    taskProtectedMessage: 'Questa attività è protetta. Disattiva "Proteggi attività" nell\'editor per eliminarla.',
  ...
  de: {
    ...
    deletePageConfirmEmpty: 'Diese Seite hat keine Elemente. Löschen?',
    itemsWillBeDeleted: 'Elemente werden gelöscht.',
    pageActions: 'Aktion für diese Seite wählen',
    protectedKept: 'geschützte bleiben erhalten',
    deleteCompletedCount: '{n} erledigte Elemente löschen?',
    deleteAllCompleted: 'Alle {n} erledigten Elemente löschen?',
    deleteCompleted: 'Erledigte löschen?',
    deleteAll: 'Alle löschen',
    allProtected: 'Alle geschützt',
    allProtectedMessage: 'Alle erledigten Elemente sind geschützt und können nicht gelöscht werden.',
    ...
    taskProtectedMessage: 'Diese Aufgabe ist geschützt. Deaktivieren Sie "Aufgabe schützen" im Editor zum Löschen.',
